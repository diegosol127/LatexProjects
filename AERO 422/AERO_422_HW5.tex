...
\begin{parts}
    ...
    \ans{Denote the transfer functions of the inner and outer loops by $T_1(s)$ and $T_2(s)$, respectively. $$T_1(s) = \frac{P(s)C(s)}{1 + P(s)C(s)K_T}$$ $$T_2(s) = \frac{T_1(s) \cdot \frac{1}{s}}{1 + T_1(s) \cdot \frac{1}{s}} = \frac{P(s)C(s)}{s(1 + P(s)C(s)K_T) + (1 + P(s)C(s)K_T + P(s)C(s))}$$ We get the folowing characteristic equation for the outer loop: $$$$}
